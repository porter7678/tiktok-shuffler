...
- [X] I want a button to replay a video. Because sometime I want to start a video over before it's finished.
...
- [ ] I want a button near the artists name where I can see all their videos that I've liked.
- [ ] Any chance to get comments working? Maybe just the top 5 comments or something?