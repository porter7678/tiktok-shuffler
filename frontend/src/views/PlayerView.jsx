...
export default function PlayerView({ currentVideo, onShuffle, onTrueShuffle, onNext, onPrev, hasNext, hasPrev, onHistoryBack, onHistoryForward, canBack, canForward, showTrueShuffle, onToggleLike, onToggleFavorite, paused = false }) {
